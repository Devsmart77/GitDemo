...
public class SingleDataSet extends Base {

	public static Logger Log = LogManager.getLogger(SingleDataSet.class.getName());
	...
	public void SingleSetData(String un, String pd, String txt) throws IOException {
...
//		driver.close();
	...
	public Object[][] getData() {
		...
		data[0][0]= "sdfawedf";
		data[0][1]= "Password1";
		data[0][2]= "Only one set of credential entered";
